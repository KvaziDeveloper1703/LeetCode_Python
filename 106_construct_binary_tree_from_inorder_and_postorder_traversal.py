...
Даны два целочисленных массива — inorder и postorder, которые представляют симметричный (inorder) и обратный (postorder) обходы одного и того же бинарного дерева.
Необходимо восстановить бинарное дерево по этим обходам и вернуть его корень.
