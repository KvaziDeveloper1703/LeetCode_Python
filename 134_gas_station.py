...
Даны два массива целых чисел gas и cost. Верните индекс станции, с которой нужно начать, чтобы успешно завершить весь маршрут.
Если совершить круг невозможно ни с одной станции, верните -1.

Гарантируется, что если решение существует, то оно единственное.
