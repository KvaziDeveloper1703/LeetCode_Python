...
running_sum[i] = numbers[0] + numbers[1] + ... + numbers[i]
...
Дан массив целых чисел numbers. Необходимо вернуть префиксную сумму (running sum) этого массива.

Префиксная сумма на индексе i — это сумма всех элементов от индекса 0 до i, то есть:
running_sum[i] = numbers[0] + numbers[1] + ... + numbers[i]
