...
In some languages, there is no unsigned integer type. 
However, the underlying binary representation is the same for signed and unsigned integers. 
So treat the integer as a sequence of 32 bits and reverse the order of the bits.
