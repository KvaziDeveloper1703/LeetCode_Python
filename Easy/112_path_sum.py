...
Дано бинарное дерево и целое число target_sum.
Нужно вернуть true, если в дереве существует путь от корня до листа, сумма значений вдоль которого равна target_sum.
...
class Solution:
    def has_path_sum(self, root: Optional[TreeNode], target_sum: int) -> bool:
        ...
        return (
            self.has_path_sum(root.left, remaining_sum) or
