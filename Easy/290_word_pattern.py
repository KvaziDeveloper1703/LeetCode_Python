'''
You are given a pattern and a string S consisting of words separated by spaces. Determine if S follows the same pattern.
...
Даны строка pattern и строка S, состоящая из слов, разделённых пробелами. Необходимо определить, соответствует ли строка S шаблону pattern.
