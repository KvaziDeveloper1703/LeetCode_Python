'''
Given an array of strings words, return the words that can be typed using letters of the alphabet from only one row of the American keyboard (as shown below).
...
Дан массив строк words. Верните те слова из массива, которые можно напечатать, используя буквы только из одной строки американской клавиатуры (см. схему ниже).
