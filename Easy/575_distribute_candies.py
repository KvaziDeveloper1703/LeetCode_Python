...
Alice noticed that she was starting to gain weight, so she visited a doctor. 
The doctor advised her to eat only n / 2 of the candies she has (it is guaranteed that n is always even).
...
Алиса заметила, что начала набирать вес, и поэтому пошла к врачу. 
Врач посоветовал Алисе съесть только n / 2 конфет (гарантируется, что n всегда чётное).
