'''
Given an array of integers heights representing the heights of bars in a histogram (where the width of each bar is 1), return the area of the largest rectangle that can be formed inside the histogram.
