...
Даны два целочисленных массива — preorder и inorder, которые представляют прямой (preorder) и симметричный (inorder) обходы одного и того же бинарного дерева.
