'''
Given the root of a binary tree and an integer target_sum, return all root-to-leaf paths where the sum of the node values in the path equals target_sum.
...
Дано бинарное дерево с корнем root и целое число target_sum. Верните все пути от корня до листьев, сумма значений узлов в которых равна target_sum.
