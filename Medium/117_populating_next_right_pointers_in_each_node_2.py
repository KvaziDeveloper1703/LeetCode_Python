...
Твоя задача — заполнить поле next для каждого узла, чтобы оно указывало на следующий узел справа на том же уровне.
Если такого узла нет — установить next в NULL.

Изначально все поля next установлены в NULL.
