'''
You are playing the Bulls and Cows game with your friend. You write down a secret number, and your friend tries to guess what it is.
...
Вы играете с другом в игру "Быки и коровы". Вы загадываете секретное число, а ваш друг пытается его угадать.
