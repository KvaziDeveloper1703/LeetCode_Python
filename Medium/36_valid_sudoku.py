...
Дано игровое поле Судоку размером 9 x 9 в виде двумерного массива символов. Ваша задача — определить, является ли текущее состояние поля валидным, исходя из следующих правил:
