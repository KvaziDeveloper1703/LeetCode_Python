'''
You are given quations like A / B = value and queries like C / D = ?.
...
Вам дан список уравнений equations[i] = [A, B], где A / B = values[i] и список запросов: queries[j] = [C, D] — нужно найти C / D.
Верни список ответов на запросы. Если ответ определить нельзя, верни -1.0.

Пример:
Ввод: equations = [["a","b"],["b","c"]], values = [2.0, 3.0], queries = [["a","c"],["b","a"],["a","e"],["a","a"],["x","x"]]
Вывод: [6.0, 0.5, -1.0, 1.0, -1.0]
'''
