'''
You are given an array of distinct integers called candidates and an integer target.
Your task is to return all unique combinations of numbers from candidates that sum up exactly to target.
