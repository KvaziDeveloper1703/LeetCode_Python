...
Дан список чисел candidates и целевое число target. 
Найдите все уникальные комбинации чисел из candidates, сумма которых равна target.
Каждое число из candidates можно использовать только один раз в каждой комбинации.
Важно: Множество решений не должно содержать повторяющихся комбинаций.
