...
На плоской стене, представляющей собой координатную плоскость XY, прикреплены сферические воздушные шары.
    + Каждый шар задан в виде двумерного массива points, где points[i] = [x_start, x_end] — это горизонтальный диаметр шара, простирающийся от x_start до x_end;
    + Точные координаты по y неизвестны;
    + Вы можете стрелять стрелами вверх (по положительному направлению оси Y) из любых точек на оси X;
    + Одна стрела, пущенная из точки x, пробивает все шары, у которых x_start <= x <= x_end;
    + Стрел можно выпустить сколько угодно, и они летят вверх бесконечно, пробивая все шары на своём пути.
