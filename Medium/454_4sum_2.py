...
Return the number of tuples (i, j, k, l) such that: 0 <= i, j, k, l < n, and numbers_1[i] + numbers_2[j] + numbers_3[k] + numbers_4[l] == 0

Example:
Input: numbers_1 = [1, 2], numbers_2 = [-2, -1], numbers_3 = [-1, 2], numbers_4 = [0, 2]
Output: 2

Даны четыре массива целых чисел: numbers_1, numbers_2, numbers_3 и numbers_4, каждый длины n.
Найти количество четвёрок индексов (i, j, k, l), таких что: 0 <= i, j, k, l < n, и numbers_1[i] + numbers_2[j] + numbers_3[k] + numbers_4[l] == 0

Пример:
Ввод: numbers_1 = [1, 2], numbers_2 = [-2, -1], numbers_3 = [-1, 2], numbers_4 = [0, 2]
Вывод: 2
'''
