...
Sort the array in-place so that objects of the same color are adjacent, with the colors in the order: red, white, then blue.
...
Отсортируйте массив на месте так, чтобы одинаковые цвета шли рядом, а порядок цветов был: красный, затем белый, затем синий.
Нельзя использовать встроенные функции сортировки.
'''
