...
Слово может быть составлено из последовательно соседних ячеек, где соседними считаются ячейки, находящиеся по горизонтали или вертикали. 
Одна и та же ячейка не может быть использована более одного раза при составлении слова.
