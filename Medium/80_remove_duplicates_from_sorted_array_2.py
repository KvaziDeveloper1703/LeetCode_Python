...
Since it's not possible to change the size of the array in some programming languages, you should place the result in the first part of the array numbers. More formally:
...
Дан отсортированный по неубыванию массив целых чисел numbers. Необходимо изменить массив на месте так, чтобы каждое уникальное число встречалось не более двух раз, при этом сохранив относительный порядок элементов.
...
Примеры:
Ввод: numbers = [1, 1, 1, 2, 2, 3]
Вывод: 5, numbers = [1, 1, 2, 2, 3, _]

Ввод: numbers = [0, 0, 1, 1, 1, 1, 2, 3, 3]
Вывод: 7, numbers = [0, 0, 1, 1, 2, 3, 3, _, _]
'''
