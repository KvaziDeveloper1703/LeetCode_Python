'''
You are given an integer n. Your task is to return all structurally unique Binary Search Trees that store values from 1 to n.
...
Дано целое число n. Необходимо вернуть все структурно уникальные бинарные деревья поиска, которые можно построить, используя значения от 1 до n.
