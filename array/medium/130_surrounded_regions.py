...
To capture a surrounded region, you must replace all 'O's in it with 'X's directly in the original board. You do not return anything — modify the board in-place.
...
Чтобы захватить область, нужно заменить все 'O' в ней на 'X' в самой матрице. Возвращать ничего не нужно — изменения происходят на месте.
