...
Найдите наименьшее количество монет, необходимое для составления этой суммы. Если невозможно набрать такую сумму с помощью данных монет, верните -1. Можно считать, что каждой монеты доступно бесконечно много.
...
def coin_сhange(coins: List[int], amount: int) -> int:
