...
Given two integers m and n, return the number of unique paths the robot can take to reach the bottom-right corner. It is guaranteed that the answer will not exceed 2 * 10⁹.
...
По заданным значениям m и n, верните количество уникальных путей, по которым робот может дойти до правого нижнего угла. Гарантируется, что ответ не превышает 2 * 10⁹.
