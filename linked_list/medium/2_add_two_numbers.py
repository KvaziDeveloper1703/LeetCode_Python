...
Examples:
Input: list_1 = [2,4,3], list_2 = [5,6,4]
Output: [7,0,8]

Input: list_1 = [0], list_2 = [0]
Output: [0]

Даны два непустых связных списка, представляющих два неотрицательных числа.
Цифры хранятся в обратном порядке, и каждый узел содержит одну цифру.
Необходимо сложить эти два числа и вернуть результат в виде связного списка.
Можно предположить, что оба числа не содержат ведущих нулей, за исключением самого числа 0.

Примеры:
Ввод: list_1 = [2, 4, 3], list_2 = [5, 6, 4]
Вывод: [7, 0, 8]

Ввод: list_1 = [0], list_2 = [0]
Вывод: [0]
'''
