...
In one move, you can increment or decrement any single element of the array by 1. It is guaranteed that the result will fit in a 32-bit integer.
...
За один шаг можно увеличить или уменьшить значение одного элемента массива на 1. Гарантируется, что ответ помещается в 32-битное целое число.
